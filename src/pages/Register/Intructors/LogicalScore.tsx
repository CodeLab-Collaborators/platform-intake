...
import { logicalScore } from '../../../utils/APIs';
                                        ...
                                        <Carded>
                                            ...
                                            <Score>
                                                ...
                                                />
                                                {
                                                    ...
                                                    props.logic === 0 ? <Button
                                                        bg="l"
                                                        cur="l"
                                                        onClick={() => {
                                                            logicalScore(props._id, { logic: score }).then(() => {
                                                                Swal.fire({
                                                                    title: `${props.name} Logical score has been entered successfully!`,
                                                                    icon: "success",
                                                                    timer: 3000,
